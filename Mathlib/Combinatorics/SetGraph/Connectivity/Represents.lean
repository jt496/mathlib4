...
* `SetGraph.ConnectedComponent.Represents` says that a set of vertices represents a set of
...
namespace SetGraph.ConnectedComponent
...
end SetGraph.ConnectedComponent.Represents
